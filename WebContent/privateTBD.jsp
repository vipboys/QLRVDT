...
<body>
	...
	<c:set var="chon" scope="session" value="TBD"/>
	...
	<c:import url="privateTopMenu.jsp"/>
		...
		<div class="row" style="margin-top: -40px;">
			<div class="bs-example">
				<div class="col-lg">
                	<h3 class="page-header">Thêm Bài Đăng</h3>
                </div>
                <div class="table-responsive">
                <!-- /.row -->
			        <div class="row" style="width: 100%;padding-left: 10px;">
		            	<div class="col-sm-10">
		                <html:form action="/privateTBD" method="post" enctype="multipart/form-data">
